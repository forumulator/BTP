...
from neuralnet.rnnmodels import make_rnn_model
import math
...
class SequentialNeuralNetRunner(object):
    ...
    def _format_data(self, df):
        ...
        tr, ts = Splitter(TS_SIZE, seq=True).split(df)
    ...
    def run(self, df):
        ...
        self.model = make_rnn_model(self.model_name)
        # Split data
